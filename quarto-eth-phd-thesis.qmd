...
Here is the example produced by the template for you to view: [Example PDF](assets/quarto-eth-phd-thesis.pdf)
...
![Rendered ETH title page](assets/titlepage.png){fig-align="center" width="60%"}
...
![Callout block for article details](assets/article-details.png){fig-align="center" width="60%"}
